Important Note: This is a fork of the project phoenix_token_auth, this fork include the use of gen_smtp library to allow send message from any smtp server.
